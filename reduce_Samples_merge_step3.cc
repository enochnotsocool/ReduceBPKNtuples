...
void reduce_Samples_merge_step3()
{
...
{      
    ...
    string data_folder="./REDUCE_DATA_Summer12_"+sample_style_+"_id/PhotonData/";
    string MC_folder="./REDUCE_DATA_Summer12_"+sample_style_+"_id/";
    ...
    sprintf(buffer,"./REDUCE_DATA_Summer12_%s_id_vtx/%s_%s.root",sample_style_.c_str(),sample_style_.c_str(),datatag);
