...
void reduce_Samples_merge_step4()
{
...
{      
    ...
    string data_folder="./REDUCE_DATA_Summer12_"+sample_style_+"_id_vtx/PhotonData/";
    string MC_folder="./REDUCE_DATA_Summer12_"+sample_style_+"_id_vtx/";
    ...
    ReduceTree(root);
    root->SetBranchStatus("EvtInfo.TrgBook"      ,0);
    ...
    sprintf(buffer,"./REDUCE_DATA_Summer12_%s_id_vtx_removeHLT/%s_%s.root",sample_style_.c_str(),sample_style_.c_str(),datatag);
...
//*/
	    ...
	    if(NJets<4) continue;
	    if(JetInfo.Pt[0]<55) continue;
	    if(JetInfo.Pt[1]<45) continue;
	    if(JetInfo.Pt[2]<35) continue;
